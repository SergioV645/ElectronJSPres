...
<head>
  ...
  <meta name="description" content="Programación con Electron">
  <meta name="author" content="Iker Landajuela">
  <link rel="shortcut icon" href="../../../../../favicon.ico">
  
  <title>Home - Programación con Electron</title>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "src\\basico\\mi-primera-app\\node_modules\\ajv\\README.md";
    var mkdocs_page_url = "/electron/src/basico/mi-primera-app/node_modules/ajv/";
  </script>
...
<body class="wy-body-for-nav" role="document">
  ...
  <div class="wy-grid-for-nav">
    ...
    <nav data-toggle="wy-nav-shift" class="wy-nav-side stickynav">
      <div class="wy-side-nav-search">
        <a href="../../../../.." class="icon icon-home"> Programación con Electron</a>
        <div role="search">
  <form id ="rtd-search-form" class="wy-form" action="../../../../../search.html" method="get">
    ...
    <a class="" href="../../../../../instalacion/instalacion/">Instalación</a>
	    </li>
          
            <li class="toctree-l1">
		
    <span class="caption-text">Básico</span>
    <ul class="subnav">
                <li class="">
                    
    <a class="" href="../../../../../basico/mi-primera-app/mi-primera-app/">Mi primera App</a>
                </li>
                <li class="">
                    
    <a class="" href="../../../../../basico/dos-ventanas/dos-ventanas/">Múltiples ventanas</a>
                </li>
    </ul>
	    </li>
    ...
    <a class="" href="../../../../../recursos/recursos/">Recursos</a>
	    </li>
    ...
    <section data-toggle="wy-nav-shift" class="wy-nav-content-wrap">
      ...
      <nav class="wy-nav-top" role="navigation" aria-label="top navigation">
        ...
        <a href="../../../../..">Programación con Electron</a>
      </nav>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li class="wy-breadcrumbs-aside">
        ...
        <a href="https://gitlab.com/soka/electron/edit/master/docs/src/basico/mi-primera-app/node_modules/ajv/README.md"
...
<a href="https://github.com/epoberezkin/ajv/tree/beta"><img alt="npm@beta" src="https://img.shields.io/npm/v/ajv/beta.svg" /></a>
...
<a href="https://greenkeeper.io/"><img alt="Greenkeeper badge" src="https://badges.greenkeeper.io/epoberezkin/ajv.svg" /></a>
...
<h2 id="using-version-5">Using version 5</h2>
...
<pre><code class="javascript">ajv.addMetaSchema(require('ajv/lib/refs/json-schema-draft-04.json'));
</code></pre>
...
<ul>
<li>Ajv implements full JSON Schema <a href="http://json-schema.org/">draft 6</a> and draft 4 standards:</li>
...
<pre><code class="javascript">var ajv = new Ajv({schemas: [schema, defsSchema]});
var validate = ajv.getSchema('http://example.com/schemas/schema.json');
</code></pre>

<p>or use <code>addSchema</code> method:</p>
<pre><code class="javascript">var ajv = new Ajv;
...
<pre><code class="javascript">var ajv = new Ajv({$data: true});
...
<pre><code class="javascript">ajv.addKeyword('range', {
  type: 'number',
...
<pre><code class="javascript">var setupAsync = require('ajv-async');
...
<pre><code class="javascript">var ajv = new Ajv({ async: 'es7', processCode: transpileFunc });
var validate = ajv.compile(schema); // transpiled es7 async function
validate(data).then(successFunc).catch(errorFunc);
</code></pre>
...
<pre><code class="javascript">var validate = new Ajv().addSchema(schema).addFormat(name, regex).getSchema(uri);
</code></pre>
...
<p>There is no need to explicitly add draft 6 meta schema (http://json-schema.org/draft-06/schema and http://json-schema.org/schema) - it is added by default, unless option <code>meta</code> is set to <code>false</code>. You only need to use it if you have a changed meta-schema that you want to use to validate your schemas. See <code>validateSchema</code>.</p>
...
<li><em>logger</em>: sets the logging method. Default is the global <code>console</code> object that should have methods <code>log</code>, <code>warn</code> and <code>error</code>. Option values:</li>
...
<li><code>"es7"</code> - compile to es7 async function. Unless your platform supports them you need to provide <code>processCode</code> or <code>transpile</code> option. According to <a href="http://kangax.github.io/compat-table/es7/">compatibility table</a>) async functions are supported by:<ul>
<li>Firefox 52,</li>
<li>Chrome 55,</li>
...
<li><code>undefined</code>/<code>true</code> - auto-detect async mode. It requires <a href="https://github.com/epoberezkin/ajv-async">ajv-async</a> package. If <code>transpile</code> option is not passed, ajv-async will choose the first of supported/installed async/transpile modes in this order:<ul>
...
<p>If none of the options is available the exception will be thrown.
- <em>transpile</em>: Requires <a href="https://github.com/epoberezkin/ajv-async">ajv-async</a> package. It determines whether Ajv transpiles compiled asynchronous validation function. Option values:
  - <code>"nodent"</code> - transpile with <a href="https://github.com/MatAtBread/nodent">nodent</a>. If nodent is not installed, the exception will be thrown. nodent can only transpile es7 async functions; it will enforce this mode.
  - <code>"regenerator"</code> - transpile with <a href="https://github.com/facebook/regenerator">regenerator</a>. If regenerator is not installed, the exception will be thrown.
  - a function - this function should accept the code of validation function as a string and return transpiled code. This option allows you to use any other transpiler you prefer. If you are passing a function, you can simply pass it to <code>processCode</code> option without using ajv-async.</p>
...
<p><a href="https://github.com/epoberezkin/ajv/blob/master/LICENSE">MIT</a></p>
  ...
  <div class="rst-versions" role="note" style="cursor: pointer">
    <span class="rst-current-version" data-toggle="rst-current-version">
          ...
          <a href="https://gitlab.com/soka/electron/" class="icon icon-gitlab" style="float: left; color: #fcfcfc"> GitLab</a>
...
Build Date UTC : 2018-10-29 16:11:44
-->
